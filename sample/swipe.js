...
// 添加自定义监听事件 pc端为mousedown  移动端为touchstart
Swipe.prototype.addEvent = function(){
	
	// 判断是移动设备还是pc设备 true表示移动端 false表示pc端
	
	console.log(window.navigator.userAgent)
	this.device = (/android|iphone|ipad|webos|blackberry/i.test(window.navigator.userAgent.toLocaleLowerCase()))
